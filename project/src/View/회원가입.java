						...
						public void actionPerformed(ActionEvent e) {
							...
							if(result1) {
								...
								if(result) {
									...
									shopkeeper_id.setText(null);
									shopkeeper_pw.setText(null);
									shopkeeper_name.setText(null);
									shopkeeper_lic.setText(null);
									shopkeeper_tel.setText(null);
									shopkeeper_address.setText(null);
						...
						public void mouseClicked(MouseEvent e) {
							...
							if(result1) {
								...
								if(result) {
									...
									rider_id.setText(null);
									rider_loc.setText(null);
									rider_name.setText(null);
									rider_pw.setText(null);
									PhoneNumber2.setText(null);
									autobike.setSelected(false);
