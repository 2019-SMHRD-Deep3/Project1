...
Insert into SHOPKEEPER values ('6','6','굽네치킨','0987',6666666666,'1235898-6','2');
Insert into SHOPKEEPER (SHOPKEEPER_ID,PW,SHOPNAME,SHOP_ADDRESS,BUSINESS_LICENSE,SHOP_TEL,SECTOR) values ('7','7','김밥나라','56485',7777777777,'5489-524','1');
Insert into SHOPKEEPER (SHOPKEEPER_ID,PW,SHOPNAME,SHOP_ADDRESS,BUSINESS_LICENSE,SHOP_TEL,SECTOR) values ('8','8','중화루','13578',8888888888,'98725-54','5');
Insert into SHOPKEEPER (SHOPKEEPER_ID,PW,SHOPNAME,SHOP_ADDRESS,BUSINESS_LICENSE,SHOP_TEL,SECTOR) values ('9','9','카베베네','2315',9999999999,'54654564','6');
Insert into SHOPKEEPER (SHOPKEEPER_ID,PW,SHOPNAME,SHOP_ADDRESS,BUSINESS_LICENSE,SHOP_TEL,SECTOR) values ('14','14','한솥','65415',14141499,'5654664','1');
